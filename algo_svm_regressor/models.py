...
class BayesSvmRegressor(models.Model):
    step = models.ForeignKey(Step, models.CASCADE, blank=True, null=True)
    dataframe = models.ForeignKey(Paper, models.SET_NULL, blank=True, null=True, related_name="svr_dataframe")
    model = models.ForeignKey(Paper, models.SET_NULL, blank=True, null=True, related_name="svr_model")
...
class Column(models.Model):
    algorithm = models.ForeignKey(BayesSvmRegressor, models.CASCADE)
