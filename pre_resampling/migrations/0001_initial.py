    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dataframe', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='resampling_dataframe', to='library.paper')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('algorithm', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='pre_resampling.resampling')),
            ],
        ),
    ]
